...
public class TitleAnimationController : MonoBehaviour
{
  ...
  private void Start()
  {
    ...
    m_SpriteOpacityId  = Shader.PropertyToID( "_SpriteOpacity" );
  ...
  private void SetProperties()
  {
    ...
    m_Mat.SetFloat( m_SpriteOpacityId,  m_SpriteOpacity );
  }
}
